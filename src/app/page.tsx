    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <main className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-12 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-primary mb-6">
          ...
          <div className="flex flex-col sm:flex-row mt-8 gap-4 items-center justify-center">
            {isSignedIn ? (
              <Button size="lg" className="px-6 py-2 text-sm w-full sm:w-auto" onClick={handleGetStarted}>
                Get Started
              </Button>
            ) : (
              <SignInButton mode="modal">
                <Button size="lg" className="px-6 py-2 text-sm w-full sm:w-auto">
                  Get Started
                </Button>
              </SignInButton>
            )}
            <a href="#features" className="w-full sm:w-auto">
              <Button variant="link" className="text-sm p-0 h-auto w-full sm:w-auto">
                Learn More →
              </Button>
            </a>
          </div>
        ...
        {/* Features Section */}
        <section id="features" className="mt-16 sm:mt-20 lg:mt-24 max-w-6xl w-full">
